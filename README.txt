...
2. Display Widget only when search result equals this keyword

3. set a custom query_var in your theme/plugin and it can be referenced within this key value pair.
